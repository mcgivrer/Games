<div id="random" class="block gallery" style="width:99%;">
	<h3><?= __('game','random_title')?></h3>
	<div class="block-content" style="text-align:center;">
	<p><?php foreach($data['randomgames'] as $id=>$rgame):?>
		<a href="<?= $rgame->getPicture('cover',1,"","#")?>" rel="lightbox" title="<?= __s('game','random_show',$rgame->getInfo('support'),$rgame->getInfo('title')) ?>">
